...
Trabajo Final
<p align="center">
  <img src="assets/chapter-5/sprint4-commits-back.png" alt="Commits del trabajo final" width="700">
</p>
...
| Perfil | Criterio | PulseReport | TigerConnect Clinical Collaboration Platform | Philips IntelliVue | Epic Electronic Health Record | Oracle Health EHR | MEDITECH Expanse | Excel / Registros Clínicos |
|---|---|---|---|---|---|---|---|---|
...
| **Diferenciación frente a hardware de monitoreo** | Posicionar a PulseReport como la capa de software que da continuidad clínica a los datos de signos vitales, en lugar de competir como fabricante de monitores. | Philips IntelliVue mide y alerta sobre signos vitales a nivel de cama, pero no estructura el traspaso de turno ni el registro de eventos clínicos; PulseReport se apoya en ese vacío. |
